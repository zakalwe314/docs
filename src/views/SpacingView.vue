<template lang="pug">
  div(class="view" id="spacing-view")
    ...
    section
      ...
      component-example(header="Alignment")
        v-card
          v-card-text
    ...
    section
      ...
      component-example(header="Hidden elements")
        v-navbar(class="pl-0")
          v-navbar-logo Logo
...
<script>
  export default {
    ...
    methods: {
      meta () {
        return {
          title: 'Spacing | Vuetify.js',
          h1: 'Spacing',
          description: 'Spacing helper classes for the Vuetify Framework',
