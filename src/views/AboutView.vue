          ...
          v-col(xs12 sm12 md6 lg6)
            v-list
              v-list-item
                ...
                v-list-item-title
                  div Vuetify.js Frontend Components
          ...
          v-col(xs12 sm12 md6 lg6)
            v-list
              v-list-item
                ...
                v-list-item-title
                  div Built with Vue.js Server Side Rendering
    ...
    section
      ...
      v-list
        ...
        v-list-item
          ...
          v-list-item-title
            span Vuetify.js Admin Components <v-chip label class="green white--text">Coming Soon</v-chip>
