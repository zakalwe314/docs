              ...
              v-list-item(class="my-3")
                v-list-tile(disabled)
                  ...
                  v-list-tile-content
                    ...
                    v-list-tile-sub-title(clamp) Prototype your project in no time with easy to understand components.
              ...
              v-list-item(class="my-3")
                v-list-tile(disabled)
                  ...
                  v-list-tile-content
                    ...
                    v-list-tile-sub-title(clamp) Using an internal bus, Vuetify.js is ready from installation for SSR based applications.
        ...
        v-list-item
          v-list-tile(disabled)
            v-list-tile-avatar
              v-icon security
            v-list-tile-content
              v-list-tile-title Vuetify.js Admin Components <v-chip label class="green white--text">Coming Soon</v-chip>

    section
      h6 Roadmap
      section-text For information regarding future plans, please visit the official <strong>Roadmap</strong> on <a href="https://github.com/vuetifyjs/vuetify/projects/1" target="_blank">Github</a>.
    section
      h6 Sponsors
