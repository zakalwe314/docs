        ...
        v-card
          v-card-row(class="green darken-1")
            v-card-title(class="white--text")
              ...
              v-spacer
              div
                v-btn(icon class="white--text" v-menu:marriot="")
                  v-icon more_vert
                v-menu(
                  id="marriot"
                  top
        ...
        v-card
          v-card-row(class="blue-grey darken-1 white--text")
            v-card-title
              span Visit Space
              v-spacer
              v-btn(icon class="white--text" v-menu:space="")
                v-icon more_vert
              v-menu(
                id="space"
                top
          ...
          v-card-row(actions class="blue-grey darken-1")
            v-btn(flat class="white--text") Get Started
            v-spacer
        ...
        v-card(horizontal)
          ...
          v-card-column
            v-card-row(height="75px" class="brown white--text")
              v-card-text
                strong Reservation at Lazy Bear
                div Feb 23, 7:00pm
            v-card-row(actions class="brown darken-2")
              v-btn(flat class="white--text")
                v-icon(left) directions
                |Directions
      div
        v-card(horizontal)
