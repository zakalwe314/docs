<template lang="pug">
  div.view
    ...
    section(v-if="doc.props || doc.slots || doc.events || doc.functional")
      ...
      //- v-tabs
      //-   v-tabs-tabs
      //-     v-tab-item(ripple v-bind:item="{ href: '#props', text: 'Props' }" v-if="doc.props")
      //-     v-tab-item(ripple v-bind:item="{ href: '#slots', text: 'Slots' }" v-if="doc.slots")
      //-     v-tab-item(ripple v-bind:item="{ href: '#events', text: 'Bus Events' }" v-if="doc.events")
      //-     v-tab-item(ripple v-bind:item="{ href: '#functional', text: 'Functional' }" v-if="doc.functional")
      //-   v-tabs-items
